...
function Navbar() {
  ...
  return (
    <nav className='flex items-center justify-between flex-wrap bg-blue-600 p-6'>
        <div className='flex items-center flex-shrink-0 text-yellow-300 mr-6'>
            <Link to='/' className='font-semibold text-xl tracking-tight'>Car Inventory</Link>
        </div>
        <div className="block">
            <button 
                onClick={dropDown}
                className="flex items-center px-3 py-2 text-yellow-300 
                border rounded border-yelloe-300 hover:text-white hover:border-white"
                >
        ...
        { isVisible ? ( 
            <div className='w-full block flex-grow items-center'>
                <div className="text-sm lg:flex-grow">
                    <Button className="p-3 m-6 bg-red-600 justify-center">
                        <div>
                            <Link to='/' onClick={ clicked } className='flex place-items-center mt-4 lg:inline-block lg:mt-0 
                            text-yellow-300 hover:text-white mr-4 text-align-center'>
                                Home
                            </Link>
                        </div>
                    </Button>
                    <Button className="p-3 m-5 bg-red-600 justify-center">
                        <div>
                            ...
                            text-yellow-300 hover:text-white mr-4'>
                                About
                            </Link>
                        </div>
                    </Button>
                        ...
                        <Button className='p-3 m-5 bg-red-600 justify-center'>
                            <div>
                                <Link to="/" onClick={ () => { signInOnClick()}} className="flex place-items-center mt-4
                                 lg:inline-block lg:mt-0 text-yellow-300 hover:text-white">
                                    Login
                                </Link>
                            </div>
                        </Button>
