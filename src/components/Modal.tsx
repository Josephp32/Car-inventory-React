...
const Modal = ( props: Props ) => {
    ...
    return (
        ...
        >
            <div
                className='max-w-600px w-2/5 flex z-1 -m-3 bg-white shadow-xl rounded '
                onClick={(e) => {
                    e.stopPropagation()
                }}    
            >
                <div className="w-full flex flex-col">
                    <div className="flex flex-row space-apart">
                        <p className="flex justify-start m-0 bg-slate-300 p-1 rounded hover:bg-slate-800 text-white"
                        onClick={props.onClose}>
                            X
                        </p>
                    </div>
